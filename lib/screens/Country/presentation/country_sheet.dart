...
class CategoryHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  CategoryHeaderDelegate({required this.selectedCategory, required this.onCategorySelected});
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    return Material( // Wrap with Material to ensure decoration applies correctly
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: selectedCategory == category ? Colors.purple : Colors.black,
                      ),
                    ),
                  ],
                ),
