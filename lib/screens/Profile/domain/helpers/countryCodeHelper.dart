class CountryCodeHelper {
  static const Map<String, String> countryNameToCode = {
    ...
    "Comoros": "KM",
    "Congo": "CG",
    "Congo, The Democratic Republic og": "CD",
    "Costa Rica": "CR",
    "Croatia": "HR",
    "Cuba": "CU",
    "Cyprus": "CY",
...
extension CountryCodeExtension on String {
  String toCountryName() {
    ...
    final nameEntry = CountryCodeHelper.countryNameToCode.entries
        .firstWhere(
          (entry) => entry.value.toUpperCase() == code,
      orElse: () => MapEntry(this, ""),
    );

    return nameEntry.key;
  }
}